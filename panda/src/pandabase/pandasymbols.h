...
#ifdef BUILDING_PANDA_GNS
  #define EXPCL_PANDA_GNS EXPORT_CLASS
  #define EXPTP_PANDA_GNS EXPORT_TEMPL
#else
  #define EXPCL_PANDA_GNS IMPORT_CLASS
  #define EXPTP_PANDA_GNS IMPORT_TEMPL
#endif
